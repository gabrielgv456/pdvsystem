                            ...
                            props.item.type === 'others' && props.isSellEnded === false ?
                                ...
                                props.item.type === 'onDelivery' && props.isSellEnded === false ?
                                    <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#acc6fc', color: 'var(--Blue)' }}>
                                        ...
                                        <S.Label><label style={{ backgroundColor: 'var(--Blue)', padding: '0px 8px', color: '#fff', borderRadius: '3px 0px 0px 3px', height: '1.1rem' }}>R$</label><S.InputModal placeholder="0,00" maxLength={12} value={props.item.valueFormated} onChange={(e) => changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
