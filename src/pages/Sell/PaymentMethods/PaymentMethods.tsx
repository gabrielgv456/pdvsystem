        ...
        <>
            {props.item.type === 'money' && props.isSellEnded === false ?
                <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#bceeb4', color: '#1f5018' }}>
                    ...
                    <S.Label ><label style={{backgroundColor:'#1f5018',padding:'0px 8px',color:'#fff', borderRadius:'3px 0px 0px 3px',height:'1.1rem'}}>R$</label><S.InputModal  maxLength={12}  value={props.item.valueFormated} onChange={(e) => changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
                ...
                props.item.type === 'debitcard' && props.isSellEnded === false ?
                    <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#fcedc2', color: '#f1b917' }}>
                        ...
                        <S.Label><label style={{backgroundColor:'#f1b917',padding:'0px 8px',color:'#fff', borderRadius:'3px 0px 0px 3px',height:'1.1rem'}}>R$</label><S.InputModal  maxLength={12}  value={props.item.valueFormated} onChange={(e) => changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
                    ...
                    props.item.type === 'creditcard' && props.isSellEnded === false ?
                        <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#fccbd6', color: '#da506e' }}>
                            ...
                            <S.Label><label style={{backgroundColor:'#da506e',padding:'0px 8px',color:'#fff', borderRadius:'3px 0px 0px 3px',height:'1.1rem'}}>R$</label><S.InputModal maxLength={12} value={props.item.valueFormated} onChange={(e) => changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
                        ...
                        props.item.type === 'pix' && props.isSellEnded === false ?
                            <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#c3f0eb', color: '#5cbcb1' }}>
                                ...
                                <S.Label>PIX</S.Label>
                                <S.Label><label style={{backgroundColor:'#5cbcb1',padding:'0px 8px',color:'#fff', borderRadius:'3px 0px 0px 3px',height:'1.1rem'}}>R$</label><S.InputModal maxLength={12}  value={props.item.valueFormated} onChange={(e) =>  changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
                            ...
                            props.item.type === 'others' && props.isSellEnded === false ?
                                <S.DivPaymentMethods style={{ borderRadius: 5, backgroundColor: '#c5b4b4', color: '#7a3c3c' }}>
                                    ...
                                    <S.Label><label style={{backgroundColor:'#7a3c3c',padding:'0px 8px',color:'#fff', borderRadius:'3px 0px 0px 3px',height:'1.1rem'}}>R$</label><S.InputModal  maxLength={12}  value={props.item.valueFormated} onChange={(e) =>  changeValueInput(CurrencyMaskWithOutRS(e))} /></S.Label>
